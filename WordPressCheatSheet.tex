...
%        keywordstyle=[4]\textbf,   \sqrt{\sqrt{}} %
        stringstyle=\color{blue}, % Farbe der String
...
\lstinputlisting[language=HTML]{code/style.css}
...
\lstset{language=PHP}
\lstinputlisting[language=PHP]{code/index.php}
...
\lstinputlisting[language=PHP]{code/header.php}

\noindent Voorbeeld van een sidebar.php:
\lstinputlisting[language=PHP]{code/sidebar.php}

\noindent Minimale footer.php:
\lstinputlisting[language=PHP]{code/footer.php}
...
\lstinputlisting[language=PHP]{code/functions.php}
...
\lstinputlisting[language=PHP]{code/shortcode.php}
